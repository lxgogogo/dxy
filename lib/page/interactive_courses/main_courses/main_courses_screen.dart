                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => controller.onChangeType(controller.courseGroups[7]),
                            child: Container(
                              height: 16.w,
                                  ...
                                  child: controller.items.isNotEmpty
                                      ? ListView.separated(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            return GestureDetector(
                                              onTap: () => controller.toCourseDetail(),
                                              child: CourseKnowledgeItem(item: item),
                                            );
                                          },
                                          separatorBuilder: (_, __) => SizedBox(height: 12.w),
                                        )
                                  ...
                                  child: controller.items.isNotEmpty
                                      ? ListView.separated(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            return GestureDetector(
                                              onTap: () => controller.toCourseDetail(),
                                              child: CourseChallengeItem(item: item),
                                            );
                                          },
                                          separatorBuilder: (_, __) => SizedBox(height: 12.w),
                                        )
                              ...
                              'practise' => CommonRefresher(
                                  ...
                                  child: controller.items.isNotEmpty
                                      ? ListView.separated(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            final item = controller.items[index];
                                            return CoursePracticeItem(item: item);
                                          },
                                          separatorBuilder: (_, __) => SizedBox(height: 12.w),
                                        )
                                      : const Center(child: NoDataView()),
