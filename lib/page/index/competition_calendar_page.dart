                ...
                child: TableCalendar<Event>(
                  ...
                  calendarBuilders: CalendarBuilders(
                    prioritizedBuilder: (BuildContext context, DateTime day, DateTime focusedDay) {
                      final textColor = isSameDay(kToday, day) ? const Color(0xff249cfc) : const Color(0xff2c2c2c);
                      ...
                      return AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          border: eventCount > 0
                              ? Border(
                                  bottom: BorderSide(
                                    color: isPastDay ? const Color(0xfff3f6fa) : const Color(0xffd9001b),
                                    width: 3,
                                  ),
                                )
                              : null,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: isSelectedDay ? Border.all(color: const Color(0xff3c7bfa)) : null,
                          ),
                          child: Text(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${item.competition?.dayBegin != null ? DateFormat('yyyy-MM-dd-HH:mm').format(item.competition!.dayBegin!) : ''}至${item.competition?.dayEnd != null ? DateFormat('yyyy-MM-dd-HH:mm').format(item.competition!.dayEnd!) : ''}',
                              style: const TextStyle(
                                color: Color(0xff2a2a2a),
                                fontSize: 12,
                              ),
                            ...
                            SizedBox(height: 4.px),
                            Text(
                              '${item.competition?.mainDayBegin != null ? DateFormat('yyyy-MM-dd-HH:mm').format(item.competition!.mainDayBegin!) : ''}至${item.competition?.mainDayEnd != null ? DateFormat('yyyy-MM-dd-HH:mm').format(item.competition!.mainDayEnd!) : ''}',
                              style: const TextStyle(
                                color: Color(0xff2a2a2a),
                                fontSize: 12,
                              ),
